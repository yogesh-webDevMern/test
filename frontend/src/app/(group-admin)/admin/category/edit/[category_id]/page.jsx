        ...
        <div className="flex justify-between items-center mb-4 ">
            ...
            <div className='max-w-[100%]  bg-purple-500 rounded-md p-4 md:p-7'>
                <form action=""  className='block md:flex items-center  md:gap-7 text-white' onSubmit={submitHandler}>
                    ...
                    <input defaultValue={category?.name} ref={nameRef} onChange={nameChnageHandler} type="text" id="categoryName" className='outline-none px-2 max-w-full bg-purple-400 py-1 rounded placeholder-purple-800 placeholder:text-[13px] placeholder:text-center' placeholder='Enter Category Name' />
                    </span>
                  <span>
                  <label htmlFor="categorySlug" className='text-[14px] md:text-[18px]'> Category Slug  </label>
                  <input defaultValue={category?.slug} ref={slugRef} readOnly type="text" id="categorySlug" className='outline-none max-w-full px-2 py-1 bg-purple-400 rounded placeholder-purple-800 placeholder:text-[13px] placeholder:text-center' placeholder='Enter Category Slug' />
                    </span> 
                    <button  className='bg-purple-400 text-white px-2 py-1 mt-3 md:mt-0x rounded'>Update</button>
